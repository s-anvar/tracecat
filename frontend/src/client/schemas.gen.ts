...
export const $ActionRead = {
    ...
    type: 'object',
    required: ['id', 'type', 'title', 'description', 'status', 'inputs', 'is_interactive'],
    title: 'ActionRead'
} as const;
...
export const $AppSettingsRead = {
    ...
    type: 'object',
    required: ['app_registry_validation_enabled', 'app_executions_query_limit', 'app_interactions_enabled'],
...
export const $CaseRead = {
    ...
    type: 'object',
    required: ['id', 'short_id', 'created_at', 'updated_at', 'summary', 'status', 'priority', 'severity', 'description', 'fields'],
    title: 'CaseRead'
} as const;
...
export const $Role = {
    properties: {
        ...
        service_id: {
            type: 'string',
            enum: ['tracecat-runner', 'tracecat-api', 'tracecat-cli', 'tracecat-schedule-runner', 'tracecat-service', 'tracecat-executor', 'tracecat-bootstrap'],
            title: 'Service Id'
        }
    },
    type: 'object',
...
export const $SqlType = {
    type: 'string',
    enum: ['TEXT', 'INTEGER', 'DECIMAL', 'BOOLEAN', 'TIMESTAMP', 'TIMESTAMPTZ', 'JSONB', 'UUID'],
    title: 'SqlType',
...
export const $TemplateActionValidationErrorType = {
    type: 'string',
    enum: ['ACTION_NOT_FOUND', 'ACTION_NAME_CONFLICT', 'STEP_VALIDATION_ERROR', 'EXPRESSION_VALIDATION_ERROR'],
...
export const $WorkflowExecutionEventStatus = {
    type: 'string',
    enum: ['SCHEDULED', 'STARTED', 'COMPLETED', 'FAILED', 'CANCELED', 'TERMINATED', 'TIMED_OUT', 'UNKNOWN'],
...
export const $WorkflowExecutionRead = {
    ...
    type: 'object',
    required: ['id', 'run_id', 'start_time', 'status', 'workflow_type', 'task_queue', 'history_length', 'events'],
